...
app.post("/service-orders/generate", async (req, res) => {
  try {
    ...
    const templatePath = path.join(__dirname, "modelos", "MODELO_GINZAP_BASE.xlsx.xlsx");
    ...
    res.setHeader("Access-Control-Expose-Headers", "Content-Disposition, x-service-order-protocol, x-service-order-filename");
